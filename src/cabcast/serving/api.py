...
from cabcast import __version__
...
from cabcast.models.conformal import MondrianConformalizedQuantile
from cabcast.models.registry import ModelRegistry
from cabcast.optimize.rebalance import evaluate_rebalancing
from cabcast.serving.schemas import (
    ForecastRequest,
    ForecastResponse,
    HealthResponse,
    ModelCardResponse,
...
log = get_logger("cabcast.serving")
...
class ServingContext:
    def __init__(self) -> None:
        ...
        if missing:
            raise RuntimeError(
                f"missing models {missing}. Run `cabcast all` before starting the API."
            )
