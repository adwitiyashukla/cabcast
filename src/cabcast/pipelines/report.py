...
from cabcast.causal.did import run_congestion_pricing_study
from cabcast.evaluation.metrics import coverage
from cabcast.geo.graph import ZoneGraph
from cabcast.geo.zones import ZoneSet
from cabcast.logging_utils import get_logger, log_event, stage
from cabcast.models.conformal import (
    MondrianConformalizedQuantile,
    SplitConformal,
)
from cabcast.monitoring.drift import feature_drift, prediction_drift
from cabcast.optimize.rebalance import evaluate_rebalancing
from cabcast.pipelines.train import TrainingArtifacts
from cabcast.viz import plots
...
def generate(
    ...
    with stage(log, "reporting"):
        ...
        if estimable and str(artifacts.results.get("data_source", "")).startswith("synthetic"):
            from cabcast.data.synth import CRZ_SPILLOVER_EFFECT, CRZ_TRUE_EFFECT
